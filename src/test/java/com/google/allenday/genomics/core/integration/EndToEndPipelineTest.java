...
public class EndToEndPipelineTest {
    ...
    private final static String TEST_INPUT_FILE = "test_read_10.bfast.fastq";
    ...
    private final static String EXPECTED_RESULT_CONTENT_FILE = "expected_result.merged.sorted.bam";
    ...
    public void testEndToEndPipeline() throws IOException {
        ...
        GeneData geneData = prepareInputData(gcsService, fileUtils, testBucket, TEST_INPUT_FILE);
    ...
    private void checkResultContent(GCSService gcsService, FileUtils fileUtils, BlobId expectedResultBlob) throws IOException {
        ...
        File expectedResultsFile = new File(getClass().getClassLoader().getResource(EXPECTED_RESULT_CONTENT_FILE).getFile());
